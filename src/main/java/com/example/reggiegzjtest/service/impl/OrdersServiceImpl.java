...
import com.example.reggiegzjtest.entities.*;
import com.example.reggiegzjtest.service.*;
import com.example.reggiegzjtest.mapper.OrdersMapper;
...
//        查询地址数据
        ...
        AtomicInteger amount  = new AtomicInteger(0); // 初始值位0

        List<OrderDetail> orderDetails = list.stream()
                .map(item -> {
//                   订单详情  一个购物车的物品数据 赋一个值
